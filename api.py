...
def update_truck(id):
    ...
    truck.registration_number = data.get("registration_number", truck.registration_number)
...
def update_delivery(id):
    ...
    delivery.origin = data.get("origin", delivery.origin)
    delivery.destination = data.get("destination", delivery.destination)
    delivery.weight = data.get("weight", delivery.weight)
    delivery.assigned_truck_id = data.get("assigned_truck_id", delivery.assigned_truck_id)
...
@api.delete("/api/deliveries/<int:id>")
def delete_delivery(id):
    ...
    Database.session.delete(delivery)
    Database.session.commit()
